...
the [pre-check/post-check hooks](https://falconnl93.dev/watchtower/lifecycle-hooks/), but will __not__ update the
containers.
...
For details see [HTTP API](https://falconnl93.dev/watchtower/http-api-mode).
...
This enables [running multiple instances](https://falconnl93.dev/watchtower/running-multiple-instances).
