...
-   Watchtower will post a notification every time it is started. This behavior [can be changed](https://falconnl93.github.io/watchtower/arguments/#without_sending_a_startup_message) with an argument.
...
Go to [falconnl93.dev/shoutrrr/v0.8/services/overview](https://falconnl93.dev/shoutrrr/v0.8/services/overview) to
...
services:
  watchtower:
    image: falconnl93/watchtower:latest
